...
do not edit by hand (ADR-0013).** Every merge to `main` with a conventional
`feat:`/`fix:` commit updates the pending release PR; merging that release PR
tags the version, regenerates this file, and publishes the cross-compiled
...
* **snell-rollcall:** our own IPShare — the provider as a RollCall IP Proxy fronting real frames ([#1075](https://github.com/by-openclaw/go-acp/issues/1075)) ([70ac675](https://github.com/by-openclaw/go-acp/commit/70ac6752e44e09d51e619a912b9d68ba6ef888b7))
* **snell-rollcall:** reach a rack's cards through the manufacturer IPShare ([#1073](https://github.com/by-openclaw/go-acp/issues/1073)) ([aaf69ce](https://github.com/by-openclaw/go-acp/commit/aaf69ce9406859019352de9c98eb4e2cf43f329a))
* **snell-rollcall:** serve and re-walk the real controller's whole menu ([#1072](https://github.com/by-openclaw/go-acp/issues/1072)) ([43f7d34](https://github.com/by-openclaw/go-acp/commit/43f7d34393fe01a591872488f5cf41064d567f83))
* **snell-rollcall:** the RollCall connector — consumer, provider, dissector, fixtures ([#1070](https://github.com/by-openclaw/go-acp/issues/1070)) ([4f2b29c](https://github.com/by-openclaw/go-acp/commit/4f2b29ca5de3ef4ffd2bf2571442cfe4fc02206f))
...
* **cli:** carry the per-slot identity into info --output json ([#1035](https://github.com/by-openclaw/go-acp/issues/1035)) ([#1036](https://github.com/by-openclaw/go-acp/issues/1036)) ([776aef2](https://github.com/by-openclaw/go-acp/commit/776aef22a80cc8d7cb888b74a8e8e0a0a9c8b07b))
...
* **amwa+ansible:** close the Manual bucket - automated equivalents + two spec fixes ([#950](https://github.com/by-openclaw/go-acp/issues/950)) ([#951](https://github.com/by-openclaw/go-acp/issues/951)) ([4ef733a](https://github.com/by-openclaw/go-acp/commit/4ef733ac038736989eec0d200e8285c5d0df24a0))
* **amwa:** BCP-003-02 / IS-10 authorization - 682 Pass across the full auth matrix ([#873](https://github.com/by-openclaw/go-acp/issues/873)) ([2d1a525](https://github.com/by-openclaw/go-acp/commit/2d1a525b17ac71953d31840d38f6e6f4f649d152))
* **amwa:** BCP-003-03 EST provisioning + BCP-003-01 TLS serving - tool 7/0/0 ([#876](https://github.com/by-openclaw/go-acp/issues/876)) ([9c1b920](https://github.com/by-openclaw/go-acp/commit/9c1b9209e6a7c32877857b8767cb0b8361f25ced))
* **amwa:** BCP-005-01 EDID to Receiver Capabilities mapping ([#878](https://github.com/by-openclaw/go-acp/issues/878)) ([2eb7ec2](https://github.com/by-openclaw/go-acp/commit/2eb7ec252a75af09a01c7f506ef0f6557d3cd6bd))
* **amwa:** BCP-005-02 NMOS Support for IPMX/HKEP ([#880](https://github.com/by-openclaw/go-acp/issues/880)) ([c2c1dbf](https://github.com/by-openclaw/go-acp/commit/c2c1dbfd5aa356d4e55355a70a21b16809b1c9b1))
* **amwa:** BCP-005-03 NMOS Support for IPMX/PEP ([#881](https://github.com/by-openclaw/go-acp/issues/881)) ([2482f5e](https://github.com/by-openclaw/go-acp/commit/2482f5e1489591b4822c7a11d6f8525d5fb2ea38))
* **amwa:** BCP-007-03 NMOS With MXL transport binding ([#879](https://github.com/by-openclaw/go-acp/issues/879)) ([f8eb82e](https://github.com/by-openclaw/go-acp/commit/f8eb82eaac64d16d5c67b02487d9d9b32607059b))
* **amwa:** BCP-008 status monitors on the device model ([#891](https://github.com/by-openclaw/go-acp/issues/891)) ([4a2894b](https://github.com/by-openclaw/go-acp/commit/4a2894bf8a2a59392adf90691600ce560bb5dc86))
* **amwa:** coded-media register attrs + SDP + JPEG XS/MPEG-TS/MXL fixtures ([#885](https://github.com/by-openclaw/go-acp/issues/885)) ([661b27c](https://github.com/by-openclaw/go-acp/commit/661b27cb8b4a4c3664855e606753cd6eec3672c3))
* **amwa:** IS-07 MQTT transport - stdlib client, per-sender selection ([#915](https://github.com/by-openclaw/go-acp/issues/915)) ([#916](https://github.com/by-openclaw/go-acp/issues/916)) ([61b4d14](https://github.com/by-openclaw/go-acp/commit/61b4d140d4e638c04d971f38478c96d6f4abdb46))
* **amwa:** IS-08 boot_map seed - boot-routed device with real activation record ([#907](https://github.com/by-openclaw/go-acp/issues/907)) ([#908](https://github.com/by-openclaw/go-acp/issues/908)) ([4bd4296](https://github.com/by-openclaw/go-acp/commit/4bd4296e8f5ccb98c55ada394f17ea1d94032010))
* **amwa:** IS-08 routing constraints declared + enforced ([#905](https://github.com/by-openclaw/go-acp/issues/905)) ([#906](https://github.com/by-openclaw/go-acp/issues/906)) ([8c78df6](https://github.com/by-openclaw/go-acp/commit/8c78df63125e75cc87a1c915a6668803c1100369))
* **amwa:** IS-11 constraint re-negotiation moves inputs + full EDID surface ([#909](https://github.com/by-openclaw/go-acp/issues/909)) ([#910](https://github.com/by-openclaw/go-acp/issues/910)) ([2272b29](https://github.com/by-openclaw/go-acp/commit/2272b29c1bd37f238f4e534468577ad501cf0c25))
* **amwa:** IS-11 Stream Compatibility Management v1.0 - tool-verified 93 Pass / 0 Fail ([#868](https://github.com/by-openclaw/go-acp/issues/868)) ([e7b2446](https://github.com/by-openclaw/go-acp/commit/e7b2446d48a1e05ae6b0829f019486406146b707))
* **amwa:** IS-12 NCP WebSocket server over the shared MS-05 device model ([#889](https://github.com/by-openclaw/go-acp/issues/889)) ([269b38a](https://github.com/by-openclaw/go-acp/commit/269b38adc875a3eebd74959f179ec326b4736829))
* **amwa:** IS-14 Device Configuration v1.0 - tool-verified 142 Pass / 0 Fail ([#869](https://github.com/by-openclaw/go-acp/issues/869)) ([a89968c](https://github.com/by-openclaw/go-acp/commit/a89968c8305dd00516dbafad24ff7db1ab5bfac4))
* **amwa:** MS-05 constraints enforcement + DhsGainControl worker ([#903](https://github.com/by-openclaw/go-acp/issues/903)) ([#904](https://github.com/by-openclaw/go-acp/issues/904)) ([748d162](https://github.com/by-openclaw/go-acp/commit/748d1620da98fd0149e27dbd149cdc8bf751965e))
* **amwa:** NMOS conformance hardening + field verification (AMWA tool Fail=0) ([#862](https://github.com/by-openclaw/go-acp/issues/862)) ([ed6c907](https://github.com/by-openclaw/go-acp/commit/ed6c90711b469394b8ef884025b62dc1921ad907))
* **ansible+registry+cli:** BCP-003-01 TLS window + dual-certificate serving + mirror TLS ([#948](https://github.com/by-openclaw/go-acp/issues/948)) ([#949](https://github.com/by-openclaw/go-acp/issues/949)) ([f8131e3](https://github.com/by-openclaw/go-acp/commit/f8131e33e22b89deff9ddcb1904e6c7cc33684f8))
* **ansible:** amwa-validate - per-role AMWA conformance gate ([#913](https://github.com/by-openclaw/go-acp/issues/913)) ([#914](https://github.com/by-openclaw/go-acp/issues/914)) ([5e46fc0](https://github.com/by-openclaw/go-acp/commit/5e46fc0cc06884583aa34cf2175fd7afb23ffd23))
* **ansible:** auth-mode validate windows - both modes gate every upgrade ([#942](https://github.com/by-openclaw/go-acp/issues/942)) ([#943](https://github.com/by-openclaw/go-acp/issues/943)) ([f7f9f0f](https://github.com/by-openclaw/go-acp/commit/f7f9f0fecb3ca3699744bd60c4cb0e2b37cdb8f9))
* **ansible:** reboot-resilience drill + secondary runner on dhs-tools ([#938](https://github.com/by-openclaw/go-acp/issues/938)) ([#939](https://github.com/by-openclaw/go-acp/issues/939)) ([77cda56](https://github.com/by-openclaw/go-acp/commit/77cda56fe9dbdf5c3e554a89498756e17779eb0e))
* **ansible:** token-bearing companion node populates the armed registry window ([#944](https://github.com/by-openclaw/go-acp/issues/944)) ([#945](https://github.com/by-openclaw/go-acp/issues/945)) ([272f3c5](https://github.com/by-openclaw/go-acp/commit/272f3c5031f9553e0dfc86b3b3298f1ea7eb804c))
* **cerebrum-nb:** watch reports changes, takes an object list, and renders in the Tree/DM layout ([#860](https://github.com/by-openclaw/go-acp/issues/860)) ([ca4a6a5](https://github.com/by-openclaw/go-acp/commit/ca4a6a5b4e976becda17babefb1a7f2290087168))
* **cli:** --settings YAML for every verb + generated docs/cli.md ([#920](https://github.com/by-openclaw/go-acp/issues/920)) ([#921](https://github.com/by-openclaw/go-acp/issues/921)) ([2616e6b](https://github.com/by-openclaw/go-acp/commit/2616e6bb76b412e5d3d5401a1f1c8bfd4e322ac3))
* **cli+ansible:** live retune - leg addressing, label resolve, verify ([#922](https://github.com/by-openclaw/go-acp/issues/922)) ([#923](https://github.com/by-openclaw/go-acp/issues/923)) ([1e67600](https://github.com/by-openclaw/go-acp/commit/1e67600d0611a6e3efd049b97b106f4153af8d02))
* **cli:** non-blocking RFC 5424 syslog forwarding via --syslog-addr ([#934](https://github.com/by-openclaw/go-acp/issues/934)) ([#935](https://github.com/by-openclaw/go-acp/issues/935)) ([7139edf](https://github.com/by-openclaw/go-acp/commit/7139edf73eacc9cf15ea2936befac796e0054aee))
* **nmos:** IS-04 Query WebSocket watcher + consumer nmos watch ([#830](https://github.com/by-openclaw/go-acp/issues/830)) ([#833](https://github.com/by-openclaw/go-acp/issues/833)) ([4a4f2fe](https://github.com/by-openclaw/go-acp/commit/4a4f2fe6a836842fad794666afb2b80d76787bec))
* **nmos:** registry mirror verb - bridge one Registry into another ([#864](https://github.com/by-openclaw/go-acp/issues/864)) ([9ad7dc7](https://github.com/by-openclaw/go-acp/commit/9ad7dc7708a3dd0ab2745a23e4b98c314556f6eb))
* **registry+ansible:** validated, Bearer-gated mirror Query face - 7 wire fixes from the read-through gate ([#946](https://github.com/by-openclaw/go-acp/issues/946)) ([#947](https://github.com/by-openclaw/go-acp/issues/947)) ([13b3bb1](https://github.com/by-openclaw/go-acp/commit/13b3bb13baef6af2c95c99733204b07dca48b44a))
* **registry:** mirror audit trail, status endpoint, systemd unit ([#925](https://github.com/by-openclaw/go-acp/issues/925)) ([#926](https://github.com/by-openclaw/go-acp/issues/926)) ([fdc2f7f](https://github.com/by-openclaw/go-acp/commit/fdc2f7fcd43476c2b82cc09381ff4ae262a8c933))
* **registry:** mirror serves the Query API - audited MITM face ([#940](https://github.com/by-openclaw/go-acp/issues/940)) ([#941](https://github.com/by-openclaw/go-acp/issues/941)) ([d8e8e86](https://github.com/by-openclaw/go-acp/commit/d8e8e86523a8c17c584c630caacc5367a3c68f27))


### Bug Fixes

* **amwa/plant:** 30s heartbeat GC window for the conformance plant ([#895](https://github.com/by-openclaw/go-acp/issues/895)) ([6ca38b0](https://github.com/by-openclaw/go-acp/commit/6ca38b0ce74d81c7455d363cc80563f2ef66ee0a)), closes [#894](https://github.com/by-openclaw/go-acp/issues/894)
* **amwa:** adapted flow rationals mirror the constraint shape ([#909](https://github.com/by-openclaw/go-acp/issues/909)) ([#912](https://github.com/by-openclaw/go-acp/issues/912)) ([8d4a34a](https://github.com/by-openclaw/go-acp/commit/8d4a34a6d12afb330a12c621850e52e6cb80d9aa))
* **amwa:** azp is the client identity when client_id is absent ([#898](https://github.com/by-openclaw/go-acp/issues/898)) ([8b0d944](https://github.com/by-openclaw/go-acp/commit/8b0d944faeff878d3240c4b551d13fd27ef4772e)), closes [#896](https://github.com/by-openclaw/go-acp/issues/896)
* **amwa:** batch registry Query WS grains (sync + change fan-out) ([#882](https://github.com/by-openclaw/go-acp/issues/882)) ([d4a4254](https://github.com/by-openclaw/go-acp/commit/d4a4254573b30a0173ab251020bfc77ba8c71879))
* **amwa:** boot activations promote after cross-API hook wiring ([#917](https://github.com/by-openclaw/go-acp/issues/917)) ([e215693](https://github.com/by-openclaw/go-acp/commit/e215693eb75f3984f2c09e3e3c8405ddf2a05815))
* **amwa:** IS-11 flows adapt to constraints; base EDID served verbatim ([#909](https://github.com/by-openclaw/go-acp/issues/909)) ([#911](https://github.com/by-openclaw/go-acp/issues/911)) ([6a3ad0d](https://github.com/by-openclaw/go-acp/commit/6a3ad0db3a7971ee2c14f4e9f2e0e1aada0c88f3))
* **amwa:** IS-14 restore rejects null into non-nullable properties ([#902](https://github.com/by-openclaw/go-acp/issues/902)) ([7ddea92](https://github.com/by-openclaw/go-acp/commit/7ddea920ac8c400aa8191d9b18487aa27d7327fd)), closes [#901](https://github.com/by-openclaw/go-acp/issues/901)
* **amwa:** JPEG XS flow components + derived SDP sampling ([#886](https://github.com/by-openclaw/go-acp/issues/886)) ([f77f41d](https://github.com/by-openclaw/go-acp/commit/f77f41d5c510aa652d78226333031dd27f2268ae))
* **amwa:** jxsv SDP carries exactframerate from the flow grain_rate ([#887](https://github.com/by-openclaw/go-acp/issues/887)) ([e9c44f4](https://github.com/by-openclaw/go-acp/commit/e9c44f46536b189f83677497adf46b91b9e382bd))
* **amwa:** jxsv SDP echoes TP from the sender st2110_21_sender_type ([#888](https://github.com/by-openclaw/go-acp/issues/888)) ([5668736](https://github.com/by-openclaw/go-acp/commit/5668736b2e88761c69259e45ff6a9cb25c8f5ba9))
* **amwa:** mirror recovers from target 400 with an ordered resync ([#884](https://github.com/by-openclaw/go-acp/issues/884)) ([303eee9](https://github.com/by-openclaw/go-acp/commit/303eee9e5641fa00410e5cd79ab3a5749b2b8ff6))
* **amwa:** MQTT sender constraints carry exactly the staged keys ([#915](https://github.com/by-openclaw/go-acp/issues/915)) ([#919](https://github.com/by-openclaw/go-acp/issues/919)) ([54c6476](https://github.com/by-openclaw/go-acp/commit/54c647608463c00ffbde0df4b9e2ca5db5f54658))
* **amwa:** NCP generic-method semantics per IS-12-01 suite findings ([#890](https://github.com/by-openclaw/go-acp/issues/890)) ([8acc7e6](https://github.com/by-openclaw/go-acp/commit/8acc7e63f9e48ef6c8595c28d7e7707cd6ac12c3))
* **amwa:** registry enforces BCP-003-02 per-client resource ownership ([#897](https://github.com/by-openclaw/go-acp/issues/897)) ([98ac113](https://github.com/by-openclaw/go-acp/commit/98ac1139a53f3cd56119b16fb0a0a6ccc746820b)), closes [#896](https://github.com/by-openclaw/go-acp/issues/896)
* **amwa:** seed externalSynchronizationStatus NotUsed on monitors ([#893](https://github.com/by-openclaw/go-acp/issues/893)) ([9ace69d](https://github.com/by-openclaw/go-acp/commit/9ace69d8da1aff028e79eceba78a2b538ad8efb1)), closes [#892](https://github.com/by-openclaw/go-acp/issues/892)
* **amwa:** seed NcObject.enabled on BCP-008 monitors ([#900](https://github.com/by-openclaw/go-acp/issues/900)) ([4357c74](https://github.com/by-openclaw/go-acp/commit/4357c74e8a9a294cbe88e47c54accd2b55aff5e5)), closes [#899](https://github.com/by-openclaw/go-acp/issues/899)
* **ansible:** lab MQTT broker on 1884 ([#915](https://github.com/by-openclaw/go-acp/issues/915)) ([#918](https://github.com/by-openclaw/go-acp/issues/918)) ([1e160f3](https://github.com/by-openclaw/go-acp/commit/1e160f30b67e729069364d48efa250b0c103412c))
* **cerebrum-nb:** make DEVICE_NAME padding visible, and name it on a NACK ([#858](https://github.com/by-openclaw/go-acp/issues/858)) ([eaa07c3](https://github.com/by-openclaw/go-acp/commit/eaa07c32529929d08bf353415af6a12088a1af73))
* **cli:** --leg red drives single-leg senders ([#922](https://github.com/by-openclaw/go-acp/issues/922)) ([#924](https://github.com/by-openclaw/go-acp/issues/924)) ([2150a34](https://github.com/by-openclaw/go-acp/commit/2150a340c1c0353ce6fd7e3ce548c71c4484b22a))
* **nmos:** whole-collection walk follows the spec paging orientation ([#866](https://github.com/by-openclaw/go-acp/issues/866)) ([6dcb99c](https://github.com/by-openclaw/go-acp/commit/6dcb99c015bc5806b18c104d176c6441ae892ea6)), closes [#832](https://github.com/by-openclaw/go-acp/issues/832)
* **probel-sw08p:** readLoop NAK test waits for the DLE NAK before closing - no teardown race ([#806](https://github.com/by-openclaw/go-acp/issues/806)) ([#807](https://github.com/by-openclaw/go-acp/issues/807)) ([c161d9c](https://github.com/by-openclaw/go-acp/commit/c161d9c3c6a4449a53c774d47e44248d7bed19ab))
