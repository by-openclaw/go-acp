...
import { ProtectInterrogateMessageCommandParams } from './params';

/**
 * ProtectInterrogateMessage command parameters validator
 *
 * @export
 * @class CommandParamsValidator
 * @implements {IValidator<ProtectInterrogateMessageCommandParams>}
 */
export class CommandParamsValidator implements IValidator<ProtectInterrogateMessageCommandParams> {
    /**
     * Creates an instance of CommandParamsValidator
     *
     * @param {ProtectInterrogateMessageCommandParams} data the command parameters
     * @memberof CommandParamsValidator
     */
    constructor(readonly data: ProtectInterrogateMessageCommandParams) {}
     ...
     *
     * @private
     * @returns {boolean} 'true' if the deviceId is out of range; otherwise 'false'
     * @memberof CommandParamsValidator
     */
