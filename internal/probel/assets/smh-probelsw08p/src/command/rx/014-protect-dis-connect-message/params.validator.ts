...
import { ProtectDisConnectMessageCommandParams } from './params';

/**
 * ProtectDisConnectMessage command parameters validator
 *
 * @export
 * @class CommandParamsValidator
 * @implements {IValidator<ProtectDisConnectMessageCommandParams>}
 */
export class CommandParamsValidator implements IValidator<ProtectDisConnectMessageCommandParams> {
    /**
     * Creates an instance of CommandParamsValidator
     *
     * @param {ProtectDisConnectMessageCommandParams} data the command parameters
     * @memberof CommandParamsValidator
     */
    constructor(readonly data: ProtectDisConnectMessageCommandParams) {}
