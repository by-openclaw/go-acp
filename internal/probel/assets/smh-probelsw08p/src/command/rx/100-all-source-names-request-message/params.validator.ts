...
import { AllSourceNamesRequestMessageCommandParams } from './params';

/**
 * AllSourceNamesRequestMessage command parameters validator
 *
 * @export
 * @class CommandParamsValidator
 * @implements {IValidator<AllSourceNamesRequestMessageCommandParams>}
 */
export class CommandParamsValidator implements IValidator<AllSourceNamesRequestMessageCommandParams> {
    /**
     * Creates an instance of CommandParamsValidator
     *
     * @param {AllSourceNamesRequestMessageCommandParams} data the command parameters
     * @memberof CommandParamsValidator
     */
    constructor(readonly data: AllSourceNamesRequestMessageCommandParams) {}
