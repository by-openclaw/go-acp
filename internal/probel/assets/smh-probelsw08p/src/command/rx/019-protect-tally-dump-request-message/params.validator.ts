...
import { ProtectTallyDumpRequestMessageCommandParams } from './params';

/**
 * ProtectTallyDumpRequestMessage command parameters validator
 *
 * @export
 * @class CommandParamsValidator
 * @implements {IValidator<ProtectTallyDumpRequestMessageCommandParams>}
 */
export class CommandParamsValidator implements IValidator<ProtectTallyDumpRequestMessageCommandParams> {
    /**
     * Creates an instance of CommandParamsValidator
     *
     * @param {ProtectTallyDumpRequestMessageCommandParams} data the command parameters
     * @memberof CommandParamsValidator
     */
    constructor(readonly data: ProtectTallyDumpRequestMessageCommandParams) {}
    ...
    /**
     * Gets a boolean indicating whether if destinationId is out of range
