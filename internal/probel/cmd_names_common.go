...
// Bytes returns the fixed character width (4, 8, 12) for this length enum.
// Unknown enum values fall back to 8.
...
// 8-char, or 10 × 12-char names"). Callers that need more names must
// paginate.
