...
// ---------------------------------------------------------------------------
// listen seams (unreachable defensive arms)
// ---------------------------------------------------------------------------

// TestListen_RawControlError drives the unreachable c.Control error arm via
// the rawControl seam: forced to return an error, ListenConfig.Control
// returns it and ListenPacket fails, so listen returns a wrapped error.
...
// rawControl forwards to c.Control and a normal bind succeeds.
