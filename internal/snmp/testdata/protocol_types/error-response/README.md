...
**Response carrying error-status** — noSuchName for an OID the agent does not have, and noAccess for a write on the read community — the two refusals an operator meets first.
