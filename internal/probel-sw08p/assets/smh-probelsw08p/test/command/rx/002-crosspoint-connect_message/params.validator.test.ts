...
import { CommandParamsValidator } from '../../../../src/command/rx/002-crosspoint-connect-message/params.validator';
...
describe('CrossPoint Connect Message Command - CommandParamsValidator', () => {
    beforeAll(async () => {
