...
import { CommandParamsValidator } from '../../../../src/command/rx/115-single-source-association-names-request-message/params.validator';
import { CommandErrorsKeys } from '../../../../src/command/locale-data-keys';

describe('Single Source Association Names Request Message command - CommandParamsValidator', () => {
    beforeAll(async () => {
