...
import { CommandParamsValidator } from "../../../../src/command/tx/004-crosspoint-connected-message/params.validator";
...
describe('CrossPoint Connected Message Command - CommandParamsValidator', () => {
    beforeAll(async () => {
