...
import { CommandParamsValidator } from '../../../../src/command/tx/013-protect-connected-message/params.validator';
import { CommandErrorsKeys } from '../../../../src/command/locale-data-keys';

describe('Protect Connected Message - CommandParamsValidator', () => {
    beforeAll(async () => {
