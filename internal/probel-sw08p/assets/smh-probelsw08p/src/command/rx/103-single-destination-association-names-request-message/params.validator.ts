...
import { SingleDestinationAssociationNamesRequestMessageCommandParams } from './params';

/**
 * SingleDestinationAssociationNamesRequestMessage command parameters Validator
 *
 * @export
 * @class CommandParamsValidator
 * @implements {IValidator<SingleDestinationAssociationNamesRequestMessageCommandParams>}
 */
export class CommandParamsValidator
     ...
     *
     * @param {SingleDestinationAssociationNamesRequestMessageCommandParams} data the command parameters
     * @memberof CommandParamsValidator
     */
    constructor(readonly data: SingleDestinationAssociationNamesRequestMessageCommandParams) {}
