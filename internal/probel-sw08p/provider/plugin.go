...
//
// Symmetric to the consumer plugin at internal/probel-sw08p/consumer. Reuses
// internal/probel-sw08p/codec for the byte framer + per-command codecs. Per-command
