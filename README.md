...
| TSL UMD v3.1/v4/v5 | v3.1 UDP-only · v4.0 UDP-only · v5.0 UDP **and** TCP/DLE-STX | v3.1 4000 · v4.0 4004 (testbed) · v5.0 8901 UDP / 8902 TCP (testbed) | 🟡 `feat/tsl-umd-plugin-v2` — full codec + consumer + provider for all 3 versions; `dhs_tsl.lua` Wireshark dissector; **VSM + Miranda IP Emulator interop validated 2026-04-26** (single + multi-DMSG); `dhs consumer tsl-vXX listen [--bind HOST:PORT] [--tcp]` CLI verb | 🟡 same branch | [internal/tsl/CLAUDE.md](internal/tsl/CLAUDE.md) |
