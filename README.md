...
| Probel SW-P-08+ | TCP | 2008 | 🟡 PR #84 — scaffold + every spec §3.2 command (Crosspoint, Protect ×6, Names, Tie-Line, Update-Name, Salvo) + §2 retry/timeout/cap + APP_KEEPALIVE | 🟡 PR #84 — paired provider per command, compliance profile, demo 2×64×64 matrix | [memory: project_probel_sw08.md] |
