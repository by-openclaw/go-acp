...
| EVS Cerebrum NB | XML over WebSocket (ws/wss) | 40007 (configurable) | 🟡 PR #144 — work in progress. Spec is authoritative (`internal/cerebrum-nb/assets/`). | deferred | [internal/cerebrum-nb/CLAUDE.md](internal/cerebrum-nb/CLAUDE.md) · [internal/cerebrum-nb/docs/keys.md](internal/cerebrum-nb/docs/keys.md) |
