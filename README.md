...
| AMWA NMOS       | DNS-SD + HTTP/JSON REST + WebSocket; (IS-07 also MQTT) | per-API (DNS-SD discovered) | 🟡 epic #146 — Phase 1 #1/#2/#3/#4 **all merged on main 2026-04-30**: PR #147 (scaffold), PR #149 (DNS-SD + 4 modes + Tier-1 `internal/registry/` slot + harness; 10/10 verification PASS modes A/B/C/D incl. cross-vendor Mode B against EVS Cerebrum 10.100.0.5:8080), PR #153 (IS-09 v1.0.0 System API server+client + selection rule), PR #155 (IS-04 v1.3.3 Node API + Registration client + heartbeat), PR #157 (IS-04 v1.3.3 Registry — in-memory store + Registration + Query + RFC 6455 WS subscriptions + 12-s GC heartbeat watchdog, sha `7813f38`). Mode A integration verified end-to-end: Node ↔ Registry round-trips, WS sync grain + change events delivered. CLI: `dhs producer nmos serve --role {node,system}` + `dhs registry nmos serve` + `dhs consumer nmos {discover,system}`. **Required scope per spec-strict rule** (see `internal/amwa/CLAUDE.md` "Versioning"): IS-04 v1.1.3 + v1.2.2 + v1.3.3 ; IS-05 v1.0.2 + v1.1.2 ; IS-07/08/12 v1.0.1 ; IS-09 v1.0.0 ; MS-05-01/02 v1.0.0 ; BCP-002/004/006/008 v1.0.0 — every track required, none deferred. Today on main: IS-04 v1.3.3 + IS-09 v1.0.0 only. NEXT: #4b (IS-04 v1.2.2 + v1.1.3 back-compat), N8 (Controller WS subscription consumer), N9 (BCP-002 + BCP-004 validators); integration sweep across all three IS-04 minors at end of Phase 1. Recipes: `internal/amwa/docs/dns-sd-unbound.md` (pfSense Unbound) + `firewall-recipes.md` (per-OS host fw). Cross-protocol mux parked (`memory/project_cross_protocol_mux.md`). | 🟡 #4b multi-version + N8 Controller next; HA active/passive + persistent store deferred | [internal/amwa/CLAUDE.md](internal/amwa/CLAUDE.md) · [internal/amwa/docs/architecture.md](internal/amwa/docs/architecture.md) · [internal/amwa/docs/sequenced-tasks.md](internal/amwa/docs/sequenced-tasks.md) · [internal/amwa/docs/dependencies.md](internal/amwa/docs/dependencies.md) · [internal/amwa/docs/conformance.md](internal/amwa/docs/conformance.md) · [internal/amwa/docs/ha.md](internal/amwa/docs/ha.md) · [internal/amwa/docs/matrix-compliance.md](internal/amwa/docs/matrix-compliance.md) · [internal/amwa/docs/cerebrum-interop.md](internal/amwa/docs/cerebrum-interop.md) · [internal/amwa/docs/dns-sd-unbound.md](internal/amwa/docs/dns-sd-unbound.md) · [internal/amwa/docs/firewall-recipes.md](internal/amwa/docs/firewall-recipes.md) · [internal/amwa/reference.md](internal/amwa/reference.md) |
