...
| AMWA NMOS       | DNS-SD + HTTP/JSON REST + WebSocket; (IS-07 also MQTT) | per-API (DNS-SD discovered) | 🟡 epic #146 — PR #147 (Phase 0 scaffold) + PR #148 (Phase 1 step #1: stdlib-only DNS-SD codec + mDNS responder/browser + unicast resolver + peer-list + new Tier-1 plugin slot `internal/registry/` + 3 deployment modes wired in CLI + depguard rules + `go test`-gated dependency audit + `dhs_nmos.lua` mDNS dissector + devcontainer/isolated-bridge conformance harness skeleton, **34 tests green, no integration test yet**). Phase 1 #2–#6 land IS-09 + IS-04 (Node, Registry, Controller) + BCP-002/004 conformance (minimum viable slice). Cross-protocol mux parked (`memory/project_cross_protocol_mux.md`). | 🟡 PR #148 — Registry plugin registers under `internal/registry/`; HTTP face lands Phase 1 #4 | [internal/amwa/CLAUDE.md](internal/amwa/CLAUDE.md) · [internal/amwa/docs/architecture.md](internal/amwa/docs/architecture.md) · [internal/amwa/docs/sequenced-tasks.md](internal/amwa/docs/sequenced-tasks.md) · [internal/amwa/docs/dependencies.md](internal/amwa/docs/dependencies.md) · [internal/amwa/docs/conformance.md](internal/amwa/docs/conformance.md) · [internal/amwa/docs/ha.md](internal/amwa/docs/ha.md) · [internal/amwa/docs/matrix-compliance.md](internal/amwa/docs/matrix-compliance.md) · [internal/amwa/reference.md](internal/amwa/reference.md) |
