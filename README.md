...
| AMWA NMOS       | DNS-SD + HTTP/JSON REST + WebSocket; (IS-07 also MQTT) | per-API (DNS-SD discovered) | 🟡 epic #146 — Phase 1 #1-#4 **all merged on main 2026-04-30** (#147 scaffold, #149 DNS-SD, #153 IS-09 v1.0.0, #155 IS-04 v1.3.3 Node API + Registration client, #157 IS-04 v1.3.3 Registry sha `7813f38`). **Phase 2 codec architecture rollout 2026-04-30/05-01** — locked Strategy pattern under `internal/amwa/codec/spec/` (`Versioned` + generic `Registry[T]` + `SelectHighestMutual` + `ComplianceEvent`/`Reporter` DI seam). MERGED: #158 doc lock, #159 spec/ base (`c3709113`), #160 IS-04 v1.1.3+v1.2.2+v1.3.3 multi-version (`db4f73b5`), #161 IS-09 retrofit (`af3ca667`). OPEN with auto-merge: #162 IS-04 Controller (`walk` verb), #174 IS-05 v1.0.2+v1.1.2 codec base. Per-spec sub-tracker issues #163-#173 opened 2026-05-01 to scope Steps 5-15 (IS-05/07/08/12/MS-05/BCP-002/004/006/008/Wireshark/AMWA-Testing). Cross-vendor Mode B verified live against EVS Cerebrum Hosted Registry on 10.100.0.5:8080. CLI today: `dhs producer nmos serve --role {node,system}` + `dhs registry nmos serve` + `dhs consumer nmos {discover,system,walk}`. **Required scope per spec-strict rule** (`internal/amwa/CLAUDE.md` "Versioning"): IS-04 v1.1.3+v1.2.2+v1.3.3 ; IS-05 v1.0.2+v1.1.2 ; IS-07/08/12 v1.0.1 ; IS-09 v1.0.0 ; MS-05-01/02 v1.0.0 ; BCP-002/004/006/008 v1.0.0 — every track required, none deferred. NEXT: drive through Steps 6-15 (IS-07/08/12, MS-05, BCP-002/004/006/008, Wireshark dissector, AMWA NMOS Testing harness); user standing approval per `memory/feedback_nmos_auto_merge.md` — auto-merge on green CI; manual approval ONLY on the final integration-test PR (#173 Step 15). Recipes: `internal/amwa/docs/dns-sd-unbound.md` + `firewall-recipes.md`. Cross-protocol mux parked. | 🟡 Phase 2 in flight: Steps 4 + 5 PRs open, Steps 6-15 queued | [internal/amwa/CLAUDE.md](internal/amwa/CLAUDE.md) · [internal/amwa/docs/architecture.md](internal/amwa/docs/architecture.md) · [internal/amwa/docs/sequenced-tasks.md](internal/amwa/docs/sequenced-tasks.md) · [internal/amwa/docs/dependencies.md](internal/amwa/docs/dependencies.md) · [internal/amwa/docs/conformance.md](internal/amwa/docs/conformance.md) · [internal/amwa/docs/ha.md](internal/amwa/docs/ha.md) · [internal/amwa/docs/matrix-compliance.md](internal/amwa/docs/matrix-compliance.md) · [internal/amwa/docs/cerebrum-interop.md](internal/amwa/docs/cerebrum-interop.md) · [internal/amwa/docs/dns-sd-unbound.md](internal/amwa/docs/dns-sd-unbound.md) · [internal/amwa/docs/firewall-recipes.md](internal/amwa/docs/firewall-recipes.md) · [internal/amwa/reference.md](internal/amwa/reference.md) |
