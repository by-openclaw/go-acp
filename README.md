...
| Probel SW-P-02  | TCP               | 2002      | ✅ merged on main (PR #106 closed #105) — salvo 10 + VSM bulk 14 + non-VSM seqs 5/6/30-33/36-38/39-44 = 33 bytes + Wireshark; owner-only protect auth + protect-blocks-connect with state echo; VSM + Commie validated 2026-04-25; consumer matrix-config flags + bootstrap sweep + keep-alive ping parked in #128 | ✅ merged on main | [internal/probel-sw02p/CLAUDE.md](internal/probel-sw02p/CLAUDE.md) |
