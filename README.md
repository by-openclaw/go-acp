...
| AMWA NMOS       | DNS-SD + HTTP/JSON REST + WebSocket; (IS-07 also MQTT) | per-API (DNS-SD discovered) | 🟡 PR #147 (epic #146) — Phase 0 scaffold on `feat/nmos-scaffold`, **NMOS-strict-spec scope locked 2026-04-27**: per-spec ASCII architecture diagrams (Mode A/B/C/D deployment) + sequenced plan + matrix-compliance tracker (Lawo VSM verified) + HA / multi-Registry rules per IS-04 v1.3.3 + strict 4-layer dependencies (CI-enforced) + AMWA NMOS Testing tool conformance gate (per-phase suite mapping) + devcontainer + isolated-bridge harness recipe. Cross-protocol mux parked (`memory/project_cross_protocol_mux.md`). Minimum viable slice = IS-09 → IS-04 → IS-05 → IS-07 (WebSocket only) + BCP-002/004 conformance. PR #149 (Phase 1 step #1, DNS-SD + 4 deployment modes + plugin slot + dep gates + harness skeleton) stacks on top, 10/10 verification PASS across modes A/B/C/D 2026-04-29. | 🟡 PR #147 (epic #146) — Node + Registry both planned (3-role topology with dual-face Registry: consumer of registrations + provider of catalogue) | [internal/amwa/CLAUDE.md](internal/amwa/CLAUDE.md) · [internal/amwa/docs/architecture.md](internal/amwa/docs/architecture.md) · [internal/amwa/docs/sequenced-tasks.md](internal/amwa/docs/sequenced-tasks.md) · [internal/amwa/docs/dependencies.md](internal/amwa/docs/dependencies.md) · [internal/amwa/docs/conformance.md](internal/amwa/docs/conformance.md) · [internal/amwa/docs/ha.md](internal/amwa/docs/ha.md) · [internal/amwa/docs/matrix-compliance.md](internal/amwa/docs/matrix-compliance.md) · [internal/amwa/reference.md](internal/amwa/reference.md) |
