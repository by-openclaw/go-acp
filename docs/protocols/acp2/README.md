...
- Spec: [docs/protocols/acp2_protocol.pdf](../acp2_protocol.pdf)
- AN2 spec: [docs/protocols/an2_protocol.pdf](../an2_protocol.pdf)
- Wireshark dissector: [assets/dissector_acp2.lua](../../../assets/dissector_acp2.lua)
