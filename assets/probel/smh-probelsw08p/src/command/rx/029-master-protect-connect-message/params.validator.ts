...
import { MasterProtectConnectMessageCommandParams } from './params';

/**
 * MasterProtectConnectMessage command parameters validator
 *
 * @export
 * @class CommandParamsValidator
 * @implements {IValidator<MasterProtectConnectMessageCommandParams>}
 */
export class CommandParamsValidator implements IValidator<MasterProtectConnectMessageCommandParams> {
    /**
     * Creates an instance of CommandParamsValidator
     *
     * @param {MasterProtectConnectMessageCommandParams} data the command parameters
     * @memberof CommandParamsValidator
     */
    constructor(readonly data: MasterProtectConnectMessageCommandParams) {}
    ...
    /**
     * Get a boolean indicating whether the levelId is out of range
