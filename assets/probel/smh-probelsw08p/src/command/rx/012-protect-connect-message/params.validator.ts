...
import { ProtectConnectMessageCommandParams } from './params';

/**
 * ProtectConnectMessage command parameters validator
 *
 * @export
 * @class CommandParamsValidator
 * @implements {IValidator<ProtectConnectMessageCommandParams>}
 */
export class CommandParamsValidator implements IValidator<ProtectConnectMessageCommandParams> {
    /**
     * Creates an instance of CommandParamsValidator
     *
     * @param {ProtectConnectMessageCommandParams} data the command parameters
     * @memberof CommandParamsValidator
     */
    constructor(readonly data: ProtectConnectMessageCommandParams) {}
