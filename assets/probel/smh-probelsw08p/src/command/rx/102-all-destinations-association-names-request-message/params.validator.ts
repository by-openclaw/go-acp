...
import { AllDestinationsAssociationNamesRequestMessageCommandParams } from './params';

/**
 * AllDestinationsAssociationNamesRequestMessage command parameters validator
 *
 * @export
 * @class CommandParamsValidator
 * @implements {IValidator<AllDestinationsAssociationNamesRequestMessageCommandParams>}
 */
export class CommandParamsValidator implements IValidator<AllDestinationsAssociationNamesRequestMessageCommandParams> {
    /**
     * Creates an instance of CommandParamsValidator
     *
     * @param {AllDestinationsAssociationNamesRequestMessageCommandParams} data the command parameters
     * @memberof CommandParamsValidator
     */
    constructor(readonly data: AllDestinationsAssociationNamesRequestMessageCommandParams) {}
