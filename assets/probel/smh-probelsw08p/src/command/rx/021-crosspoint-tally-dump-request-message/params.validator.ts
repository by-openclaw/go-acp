...
import { CrossPointTallyDumpRequestMessageCommandParams } from './params';

/**
 * CrossPointTallyDumpRequestMessage command parameters validator
 *
 * @export
 * @class CommandParamsValidator
 * @implements {IValidator<CrossPointTallyDumpRequestMessageCommandParams>}
 */
export class CommandParamsValidator implements IValidator<CrossPointTallyDumpRequestMessageCommandParams> {
    /**
     * Creates an instance of CommandParamsValidator
     *
     * @param {CrossPointTallyDumpRequestMessageCommandParams} data the command parameters
     * @memberof CommandParamsValidator
     */
    constructor(readonly data: CrossPointTallyDumpRequestMessageCommandParams) {}
    ...
    /**
     * Gets a boolean indicating if matrixId is out of range
