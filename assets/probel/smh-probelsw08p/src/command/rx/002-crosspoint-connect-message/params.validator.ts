...
import { CrossPointConnectMessageCommandParams } from './params';

/**
 * CrossPointConnectMessage command parameters validator
 *
 * @export
 * @class CommandParamsValidator
 * @implements {IValidator<CrossPointConnectMessageCommandParams>}
 */
export class CommandParamsValidator implements IValidator<CrossPointConnectMessageCommandParams> {
    /**
     * Creates an instance of CommandParamsValidator
     *
     * @param {CrossPointConnectMessageCommandParams} data the command parameters
     * @memberof CommandParamsValidator
     */
    constructor(readonly data: CrossPointConnectMessageCommandParams) {}
