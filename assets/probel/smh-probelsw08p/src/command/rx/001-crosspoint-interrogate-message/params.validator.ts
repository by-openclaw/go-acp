...
import { CrossPointInterrogateMessageCommandParams } from './params';

/**
 * CrossPointInterrogateMessage command parameters validator
 *
 * @export
 * @class CommandParamsValidator
 * @implements {IValidator<CrossPointInterrogateMessageCommandParams>}
 */
export class CommandParamsValidator implements IValidator<CrossPointInterrogateMessageCommandParams> {
    /**
     * Creates an instance of CommandParamsValidator.
     *
     * @param {CrossPointInterrogateMessageCommandParams} data the command parameters
     * @memberof CommandParamsValidator
     */
    constructor(readonly data: CrossPointInterrogateMessageCommandParams) {}
