...
import { ProtectConnectedCommandParams } from './params';

/**
 * ProtectConnectedMessage command parameters validator
 *
 * @export
 * @class CommandParamsValidator
 * @implements {IValidator<ProtectConnectedCommandParams>}
 */
export class CommandParamsValidator implements IValidator<ProtectConnectedCommandParams> {
    /**
     * Creates an instance of CommandParamsValidator
     *
     * @param {ProtectConnectedCommandParams} data the command parameters
     * @memberof CommandParamsValidator
     */
    constructor(readonly data: ProtectConnectedCommandParams) {}
