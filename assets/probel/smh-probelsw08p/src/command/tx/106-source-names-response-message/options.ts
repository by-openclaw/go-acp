 ...
 *
 * @export
 * @interface SourceNamesResponseCommandOptions
 */
export interface SourceNamesResponseCommandOptions {
    /**
     ...
     *
     * @type {NameLength}
     * @memberof SourceNamesResponseCommandOptions
     */
    lengthOfSourceNamesReturned: NameLength;
}
...
export class CommandOptionsUtility {
     ...
     *
     * @param {SourceNamesResponseCommandOptions} options the command options
     * @returns {string} the command options textual representation
     * @memberof CommandOptionsUtility
     */
    static toString(options: SourceNamesResponseCommandOptions): string {
        return `Length of Source Names Returned:${this.toStringLengthOfNamesRequired(
            options.lengthOfSourceNamesReturned
        )}`;
    }
