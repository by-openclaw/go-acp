/**
 * CrossPoint Tally Dump (Byte) Message Command Input Paramameters
 * @export
 * @interface CrossPointTallyDumpByteCommandParams
 */
export interface CrossPointTallyDumpByteCommandParams {
    /**
     *
     * Matrix Number (0 – 15)
     * @type {number}
     * @memberof CrossPointTallyDumpByteCommandParams
     */
    matrixId: number;
...
export class CommandParamsUtility {
    ...
    static toString(params: CrossPointTallyDumpByteCommandParams): string {
