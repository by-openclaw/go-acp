...
import { ProtectDiscConnectedCommandParams } from './params';

/**
 * ProtectDisc-ConnectedMessage command parameters validator
 *
 * @export
 * @class CommandParamsValidator
 * @implements {IValidator<ProtectDiscConnectedCommandParams>}
 */
export class CommandParamsValidator implements IValidator<ProtectDiscConnectedCommandParams> {
    /**
     * Creates an instance of CommandParamsValidator
     *
     * @param {ProtectDiscConnectedCommandParams} data the command parameters
     * @memberof CommandParamsValidator
     */
    constructor(readonly data: ProtectDiscConnectedCommandParams) {}
