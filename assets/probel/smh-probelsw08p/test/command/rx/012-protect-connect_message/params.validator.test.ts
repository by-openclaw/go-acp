...
import { CommandParamsValidator } from '../../../../src/command/rx/012-protect-connect-message/params.validator';
import { CommandErrorsKeys } from '../../../../src/command/locale-data-keys';

describe('Protect Connect Message Command - CommandParamsValidator', () => {
    beforeAll(async () => {
