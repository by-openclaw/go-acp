...
import { CommandParamsValidator } from '../../../../src/command/rx/029-master-protect-connect-message/params.validator';
import { CommandErrorsKeys } from '../../../../src/command/locale-data-keys';

describe('Master Protect Connect Message Command - CommandParamsValidator', () => {
    beforeAll(async () => {
