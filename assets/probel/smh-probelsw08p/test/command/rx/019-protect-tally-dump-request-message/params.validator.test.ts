...
import { CommandParamsValidator } from '../../../../src/command/rx/019-protect-tally-dump-request-message/params.validator';
...
describe('Protect Tally Dump Request Message Command - CommandParamsValidator', () => {
    beforeAll(async () => {
