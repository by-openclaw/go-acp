...
import { CommandParamsValidator } from '../../../../src/command/rx/021-crosspoint-tally-dump-request-message/params.validator';
import { CommandErrorsKeys } from '../../../../src/command/locale-data-keys';

describe('CrossPoint Tally Dump Request Message Command - CommandParamsValidator', () => {
    beforeAll(async () => {
