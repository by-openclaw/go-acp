...
import { CommandParamsValidator } from '../../../../src/command/rx/010-protect-interrogate-message/params.validator';
import { CommandErrorsKeys } from '../../../../src/command/locale-data-keys';

describe('Protect Interrogate Message - CommandParamsValidator', () => {
    beforeAll(async () => {
