...
import { CommandParamsValidator } from "../../../../src/command/tx/125-crosspoint-group-salvo-tally-message/params.validator";
...
describe('CrossPoint Group Salvo Tally Message - CommandParamsValidator', () => {
    beforeAll(async () => {
