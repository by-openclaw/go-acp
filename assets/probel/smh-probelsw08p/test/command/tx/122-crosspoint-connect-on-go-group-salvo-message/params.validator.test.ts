...
import { CommandParamsValidator } from "../../../../src/command/tx/122-crosspoint-connect-on-go-group-salvo-message/params.validator";
...
describe('CrossPoint Connect On Go Group Salvo Acknowledge Message - CommandParamsValidator', () => {
    beforeAll(async () => {
