...
import { CommandParamsValidator } from '../../../../src/command/tx/011-protect-tally-message/params.validator';
import { CommandErrorsKeys } from '../../../../src/command/locale-data-keys';

describe('Protect Tally Message Command - CommandParamsValidator', () => {
    beforeAll(async () => {
