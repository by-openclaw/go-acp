...
import { CommandParamsValidator } from '../../../../src/command/tx/015-protect-dis-connected-message/params.validator';
import { CommandErrorsKeys } from '../../../../src/command/locale-data-keys';

describe('Protect Dis-Connected Message - CommandParamsValidator', () => {
    beforeAll(async () => {
